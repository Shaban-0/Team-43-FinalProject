		...
		<div class="section_left_container fade-in-section">
			<!-- Left container with text and button -->
		  	<div class="section_left_container_text">
		    	<p><b>"Your journey into the world of exclusive fragrances begins here..."</b></p> <!-- Left container text -->
		    	<button class="section_left_button" onmouseover="Colour_Change_Left()" onmouseout="Colour_Restore_Left()"><b>Click Here<b></button> <!-- Left container button -->
		  	</div>
		</div>
		<div class="section_right_container fade-in-section">
			<!-- Right container with text and button -->
		  	<div class="section_right_container_text">
		    	<p><b>"Dive into the sophisticated realm of our Unisex Collection..."</b></p> <!-- Right container text -->
		    	<button class="section_right_button" onmouseover="Colour_Change_Right()" onmouseout="Colour_Restore_Right()"><b>Click Here<b></button> <!-- Right container button -->
		  	</div>
		</div>
