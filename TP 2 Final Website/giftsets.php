...
<head>
    ...
    <title>Giftset Products - La Paradis</title>
...
<div id="perfumeDetailModal" class="modal">
    ...
    <div class="sorting-filtering-container">
        ...
        <input type="text" id="filterKeyword" placeholder="Search by name...">
        <button onclick="fetchAndPopulateProducts()">Apply</button>
    </div>

    <div class="owl-carousel owl-theme" id="menProductsCarousel">
    ...
    fetchAndPopulateProducts(); // Initial fetch with default options
});
    ...
    $.ajax({
        url: 'fetch_giftsets_products.php',
        type: 'GET',
        data: {
            sort: sortOption,
...
function populateCarousel(products) {
    ...
    products.forEach(function(product) {
        ...
        .append('<div class="card-image-container"><img class="card-img" src="' + product.images + '" alt="' + product.name + '"></div>')
    ...
    var carousel = $("#menProductsCarousel");
    carousel.trigger('destroy.owl.carousel'); // This line destroys the carousel
    carousel.html(''); // This clears the inner HTML making it ready for new items
}
