...
<head>
    ...
    <title>Student Discount - La Paradis</title>
</head>
<body>
<header>
...
<a href="giftsets.php" class="Link_Button" id="nav_button5"><button class="nav_btn"><b>Gift Sets</b></button></a>
    ...
    <section class="student-discount-section">
        ...
        <p>At La Paradis, we appreciate the spirit and enthusiasm of students and are pleased to offer a special discount to help you enjoy our exclusive fragrances. If you're a student, you can benefit from our student discount program.</p>

        <p>To apply for the student discount, please email us at <a href="mailto:laparadis43@gmail.com">laparadis43@gmail.com</a> with the following information:</p>
        <ul>
        ...
        <p>Once we verify your student status, we'll provide you with a unique discount code that you can use on our website for a 10% discount on all products.</p>

        <p>Don't miss this opportunity to indulge in your favorite scents for less. We're excited to support your journey with our fragrances!</p>
    </section>
