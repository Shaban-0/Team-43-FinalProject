...
<a href="giftsets.php" class="Link_Button" id="nav_button5"><button class="nav_btn"><b>Gift Sets</b></button></a>
    ...
    <!-- Section displays user's login details and allows to enable/disable 2FA -->
    <div class="LoginSec-content">
        <h1>Login & Security</h1>
        <div class="LoginSec-details">
            <p>Your Email: <span id="userEmail">user@example.com</span> <button onclick="changeEmail()">Change Email</button></p>
            <p>Your Password: <span id="userPassword">********</span> <button onclick="togglePassword()">Show Password</button> <button onclick="changePassword()">Change Password</button></p>
            <p>2FA (Two-factor Authentication): <span id="twoFactorStatus">Disabled</span> <button onclick="toggleTwoFactor()">Enable/Disable</button></p>
        </div>
    </div>
