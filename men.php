...
<head>
    ...
    <title>Men's Products - La Paradis</title>
...
function populateCarousel(products) {
    ...
    products.forEach(function(product) {
        ...
        var card = $('<div class="MWUcards-wrapper MWUcard-outline d-flex ">');
        
        // Front side of the card with image and name
        var cardFront = $('<div class="MWUcard">')
            .append('<div><img  src="uploader/' + product.images + '" alt="' + product.name + '></div>')
            .append('<div class=".MWUcard-info"><h2>' + product.name + '</h2></div>');

            var tagsContainer = $('<div class="MWUtags men"></div>');
            var tags = product.tags.split(',');
            tags.forEach(function(tag) {
                tagsContainer.append('<div class="tag">' + tag.trim() + '</div>');
            });

            // Append the tags container to the card
            cardFront.append(tagsContainer);

            // Append price
            cardFront.append('<p class="price men">' + product.price + '</p>');
