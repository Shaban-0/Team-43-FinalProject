...
try {
    ...
    $transferItems = "INSERT INTO orderitem (orderID, productID, quantity, subtotal) SELECT ?, b.productID, b.quantity, p.price * b.quantity FROM basket b JOIN product p ON b.productID = p.productID WHERE b.sessionID = ?";
