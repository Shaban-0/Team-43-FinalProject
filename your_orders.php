...
<head>
    ...
    <title>Sale Products - La Paradis</title>
...
<a href="giftsets.php" class="Link_Button" id="nav_button5"><button class="nav_btn"><b>Gift Sets</b></button></a>
    ...
    <!-- Navigation section with links to other pages within My Account -->
    <div class="sidebar">
    ...
    <div class="orders-content">
        <h1>Your Orders</h1>
        <img src="uploader/Images/delivery_truck.png" alt="Delivery Truck" class="delivery-truck">
        <!-- Timeline of user's current order -->
        <div class="timeline">
            <div id="processed" class="timeline-step" data-status="processed">Processed</div>
            <div id="outForDelivery" class="timeline-step" data-status="outForDelivery">Out for Delivery</div>
            <div id="received" class="timeline-step" data-status="received">Order has been Received</div>
        </div>
        <!-- Additional content like order details and actions here -->
        </div>
        <button class="action-btn" onclick="viewOrderDetails()">View Order Details</button>
        <button class="action-btn" onclick="cancelOrder()">Cancel Order</button>
        ...
        <table class="orders-table">
            ...
            <tbody>
                <!-- replace with PHP/JS generated content -->
                <tr>
                    <td>Perfume A</td>
                    <td>123456</td>
                    <td><a href="#">View</a></td>
